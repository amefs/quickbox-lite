      ...
      <table id="dataTable1" class="table table-bordered table-striped-col" style="font-size: 12px">
        ...
        <tbody>
          <tr>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="autodlirssi" id="autodlirssiInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>ART</td>
            ...
            <?php if (file_exists("/install/.$username.autoremovetorrents.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="modal" data-target="#artRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></button></td>
            <?php } else { ?>
          ...
          <tr>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="btsync" id="btsyncInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>Deluge</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="deluge" id="delugeInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>Denyhosts</td>
            ...
            <?php if (file_exists("/install/.denyhosts.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="modal" data-target="#denyhostsRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></button></td>
            <?php } else { ?>
          ...
          <tr>
            ...
            <?php if (file_exists("/install/.fail2ban.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="modal" data-target="#fail2banRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></button></td>
            <?php } else { ?>
          ...
          <tr>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="filebrowser" id="filebrowserInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>FBE</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="filebrowser-ee" id="filebrowsereeInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>FlexGet</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="flexget" id="flexgetInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
          <td>Flood</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="flood" id="floodInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>Let's Encrypt</td>
            ...
            <?php if (file_exists("/install/.lecert.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="modal" data-target="#lecertRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></button></td>
            <?php } else { ?>
          ...
          <td>Netdata</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="netdata" id="netdataInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
          <td>noVNC</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="novnc" id="novncInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>Plex</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="plex" id="plexInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>rTorrent</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="rtorrent" id="rtorrentInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>ruTorrent</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="rutorrent" id="rutorrentInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
          <td>Syncthing</td>
          ...
          <?php } else { ?>
            <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="syncthing" id="syncthingInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
          <?php } ?>
          </tr>
          <tr>
          <td>Transmission</td>
          ...
          <?php } else { ?>
            <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="transmission" id="transmissionInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
          <?php } ?>
          </tr>
          <tr>
          <td>qBittorrent</td>
          ...
          <?php } else { ?>
            <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="qbittorrent" id="qbittorrentInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
          <?php } ?>
          </tr>
          <tr>
            <td>x2Go</td>
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button onclick="packageInstallHandler(event)" data-toggle="modal" data-target="#sysResponse" data-package="x2go" id="x2goInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></button></td>
            <?php } ?>
          </tr>
          <tr>
            <td>ZNC</td>
            ...
            <?php if (file_exists("/install/.znc.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="modal" data-target="#zncRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></button></td>
            <?php } else { ?>
