  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="?removepackage-autodlirssi=true" id="autodlirssiRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
...
<div class="modal bounceIn animated" id="flexgetRemovalConfirm" tabindex="-1" role="dialog" aria-labelledby="flexgetRemovalConfirm" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo T('CANCEL'); ?></button>
        <a href="?removepackage-flexget=true" id="flexgetRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
...
<div class="modal bounceIn animated" id="floodRemovalConfirm" tabindex="-1" role="dialog" aria-labelledby="floodRemovalConfirm" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo T('CANCEL'); ?></button>
        <a href="?removepackage-flood=true" id="floodRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
...
<div class="modal bounceIn animated" id="netdataRemovalConfirm" tabindex="-1" role="dialog" aria-labelledby="netdataRemovalConfirm" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo T('CANCEL'); ?></button>
        <a href="?removepackage-netdata=true" id="netdataRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
...
<div class="modal bounceIn animated" id="novncRemovalConfirm" tabindex="-1" role="dialog" aria-labelledby="novncRemovalConfirm" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo T('CANCEL'); ?></button>
        <a href="?removepackage-novnc=true" id="novncRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
...
<div class="modal bounceIn animated" id="rtorrentRemovalConfirm" tabindex="-1" role="dialog" aria-labelledby="rtorrentRemovalConfirm" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo T('CANCEL'); ?></button>
        <a href="?removepackage-rtorrent=true" id="rtorrentRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
...
<div class="modal bounceIn animated" id="rutorrentRemovalConfirm" tabindex="-1" role="dialog" aria-labelledby="rutorrentRemovalConfirm" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo T('CANCEL'); ?></button>
        <a href="?removepackage-rutorrent=true" id="rutorrentRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
...
<div class="modal bounceIn animated" id="transmissionRemovalConfirm" tabindex="-1" role="dialog" aria-labelledby="TransmissionRemovalConfirm" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo T('CANCEL'); ?></button>
        <a href="?removepackage-transmission=true" id="transmissionRemove" class="btn btn-primary"><?php echo T('AGREE'); ?></a>
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
